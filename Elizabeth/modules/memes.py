...
def foryou(update, context):
    ...
    reply_text(random.choice(fun.TURKISH_STRINGS))
...
FORYOU_HANDLER = DisableAbleCommandHandler("foryou", foryou)
...
dispatcher.add_handler(FORYOU_HANDLER)
