...
# Abuse strings credits @P_rinc_e
TURKISH_STRINGS = (
    ...
    "Farkında olmadan her yolculukta seni arıyorum .. Terk edilmiş eller .. Anıların.️☹️😢.",
    "Bazıları meşgul olmasalar bile meşgul olacak, bir şekilde bizden uzak duracaklar.",
    "Hayatın karanlık yollarında tek başınıza yürürken sizi bir arada tutan ellerin gücü kimsenin umurunda değil.",
    "Kendine ait olduğu düşünülen gururun gölgesi, aynı zamanda güneşin lütfudur.",
    "Hayatta kimseyi küçümsemeyin. Unutmayın, durmuş bir saat aynı zamanda günde iki kez gerçek zamanı gösterir.",
    "Seninle tanıştığımda .. seninle konuşmaya başladığımda bilmiyordum .. Bir sonraki durakta bu biletle kalbime bir bilet alacak mısın .. yoksa son durakta inecek misin",
    "Daha fazla samimiyetin olduğu yerde, daha fazla ihmal vardır.",
    "Aldatanları değil, ihmal edilenleri değil, yığın koparanları, gözlerimiz dolduğunda kapana kısılmışları sevmeliyiz .💘..",
    "Gökyüzündeki yıldızları ve deniz kıyısındaki kum tanelerini sayarsam seni unuturum..",
    "Hayatım seninle başlamadı ama eminim hayatımın bir sonu varsa seninle olacak ve o son ana kadar seninle olacağım.",
    "Görmek istediğin yüz ve duymak istediğin ses çok uzakta olduğunda aşk sadece bir baş belasıdır..",
    "Bunun olmayacağını sanıyorsan, o zaman dünyada hiçbir şey olmayacak .. Ama olacağını sanıyorsan, hiçbir şey olmayacak ...",
    "Aşk ... elin avucundan koparılamaz ya da koparılamaz, sadece kalpten kalbe dökülebilir .❤️❤️😇..",
)
